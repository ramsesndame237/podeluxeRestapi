...
const PolitiqueLivraison = db.politiqueLivraison;
...
exports.create = (req, res) => {
    ...
    PolitiqueLivraison.create(politique)
        .then(data =>  {
...
exports.findOne = (req, res) => {
    ...
    PolitiqueLivraison.findByPk(uuid)
      .then(data => {
        res.send(data);
      })
      .catch(err => {
...
exports.update = (req, res) => {
    ...
    PolitiqueLivraison.update(req.body, {
      where: { uuid: uuid }
    })
      .then(num => {
        if (num == 1) {
